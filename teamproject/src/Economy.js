...
const Economy = (props) => {
    ...
    const title = useSelector(state => state.data.etitle);
    const ntitle = useSelector(state => state.data.entitle);
    const url = useSelector(state => state.data.eurl);
    const urlTitle = useSelector(state => state.data.eurlTitle);
    const relatedKeywords = useSelector(state => state.data.erelatedKeyword);
    const twitNums = useSelector(state => state.data.etwitNum);
    ...
    return(
        <div>
            ...
            <Table>
                <ContentsContainer>
                    <ContentsBtn onClick={()=>{
                        props.history.push("/contentsbase/Economy/RankDetail")
                        setSelect(0);
        ...
        <Switch>
        <Route path="/contentsbase/Economy/RankDetail" exact  render={(props) => (
            <RankDetail
