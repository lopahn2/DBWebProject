...
const Society = (props) => {
    ...
    const title = useSelector(state => state.data.stitle);
    const ntitle = useSelector(state => state.data.sntitle);
    const url = useSelector(state => state.data.surl);
    const urlTitle = useSelector(state => state.data.surlTitle);
    const relatedKeywords = useSelector(state => state.data.srelatedKeyword);
    const twitNums = useSelector(state => state.data.stwitNum);
    ...
    return(
        ...
        <div>
            ...
            <Table>
                <ContentsContainer>
                    <ContentsBtn onClick={()=>{
                        props.history.push("/contentsbase/Society/RankDetail")
                        setSelect(0);
        ...
        <Switch>
        <Route path="/contentsbase/Society/RankDetail" exact  render={(props) => (
            <RankDetail
